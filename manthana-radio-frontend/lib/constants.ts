...
export const MODALITIES: Modality[] = [
  ...
  },
  {
    ...
    port: 8002,
    description:
      "Brain / head MRI — TotalSegmentator total_mr volumetrics, optional SynthSeg parcellation, optional Prima, Kimi/Anthropic narrative (policy-controlled). Does not auto-route spine or MSK studies.",
