...
import type { ImageScan } from "@/hooks/useAnalysis";
...
export default function ThumbnailStrip({
  ...
  return (
    ...
    >
      {images.map((img: ImageScan, i) => {
        const isActive = i === activeIndex;
        const stage = (img as ImageScan).stage;
        const scanning = stage ? isScanning(stage) : false;
        const done = stage === "complete";
        const result = (img as ImageScan).result;
