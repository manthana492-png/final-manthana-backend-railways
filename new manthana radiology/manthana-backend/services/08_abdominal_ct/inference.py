...
def is_loaded() -> dict:
    """Component availability for /health (totalseg + optional Comp2Comp binary)."""
    totalseg_ok = False
    comp2comp_ok = False
    try:
...
def run_pipeline(
    ...
    **kwargs: Any,
    ...
    try:
        ...
        volume, _meta, loaded_from_path = load_ct_volume(work_fp, series_dir=series_dir or None)
        if ext_series:
